        ...
        layers: {
            ...
            overlays: {
                ...
                Global_30m_L1_v20170605: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=World30m_30m_L1_v20170722&band={band}'
                    },
                ...
                Global_30m_Irr_V_Rain_v20220122: {
                    ...
                    type: 'xyz',
                    params: {
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=Global_30m_RFvI_v20220125'
                    },
                    legend: [
                ...
                SouthAsia_30m_IrrRain_v20170628: {
                    ...
                    type: 'xyz',
                    params: {
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=SA_IA_IvsRF_20170628'
                    },
                    legend: [
                        {label: 'Irrigated', color: '#ff00ff'},
                        {label: 'Rainfed', color: '#ffff00'},
                ...
                Australia_rainfedvsirrigated_30m_color_20170803: {
                    ...
                    type: 'xyz',
                    params: {
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=Australia_30m_ivsr_20170803'
                    },
                ...
                Africa_250m_L2_v20160601: {
                    ...
                    params: {
                        ...
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/JustinPoehnelt/products&band={band}&id=Africa_250m_L2_v20160601&year={year}'
                    },
                ...
                Australia_250m_L3_v20160701: {
                    ...
                    params: {
                        ...
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/JustinPoehnelt/products&id=Australia_250m_L3_v20160701&band={band}&year={year}'
                    },
                    legend: [
                ...
                SouthAsia_250m_L4_v20151201: {
                    ...
                    params: {
                        ...
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/JustinPoehnelt/products&id=SouthAsia_250m_L4_v20151201&band={band}'
                    },
                    legend: [
                ...
                UnitedStates_250m_L5_v20170322_2001: {
                    ...
                    params: {
                        ...
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2001&band={band}'
                    },
                ...
                UnitedStates_250m_L5_v20170322_2002: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2002&band={band}'
                    },
                    legend: [{label: 'Corn-Soybean', color: '#FFFF00'}, {label: 'Wheat-Barley', color: '#FF0000'}]
                },
                UnitedStates_250m_L5_v20170322_2003: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2003&band={band}'
                    },
                    legend: [{label: 'Corn-Soybean', color: '#FFFF00'}, {label: 'Wheat-Barley', color: '#FF0000'}]
                },
                UnitedStates_250m_L5_v20170322_2004: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2004&band={band}'
                    },
                    legend: [{label: 'Corn-Soybean', color: '#FFFF00'}, {label: 'Wheat-Barley', color: '#FF0000'}]
                },
                UnitedStates_250m_L5_v20170322_2005: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2005&band={band}'
                    },
                    legend: [{label: 'Corn-Soybean', color: '#FFFF00'}, {label: 'Wheat-Barley', color: '#FF0000'}]
                },
                UnitedStates_250m_L5_v20170322_2006: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2006&band={band}'
                    },
                    legend: [{label: 'Corn-Soybean', color: '#FFFF00'}, {label: 'Wheat-Barley', color: '#FF0000'}]
                },
                UnitedStates_250m_L5_v20170322_2007: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2007&band={band}'
                    },
                    legend: [{label: 'Corn-Soybean', color: '#FFFF00'}, {label: 'Wheat-Barley', color: '#FF0000'}]
                },
                UnitedStates_250m_L5_v20170322_2008: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2008&band={band}'
                    },
                    legend: [
                ...
                UnitedStates_250m_L5_v20170322_2009: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2009&band={band}'
                    },
                    legend: [
                        // {label: 'Not Classified', color: '#000000'},
                        {label: 'Corn-Soybean', color: '#FFFF00'},
                ...
                UnitedStates_250m_L5_v20170322_2010: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2010&band={band}'
                    },
                    legend: [
                        // {label: 'Not Classified', color: '#000000'},
                        {label: 'Corn-Soybean', color: '#FFFF00'},
                ...
                UnitedStates_250m_L5_v20170322_2011: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2011&band={band}'
                    },
                    legend: [
                        // {label: 'Not Classified', color: '#000000'},
                        {label: 'Corn-Soybean', color: '#FFFF00'},
                ...
                UnitedStates_250m_L5_v20170322_2012: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2012&band={band}'
                    },
                    legend: [
                        // {label: 'Not Classified', color: '#000000'},
                        {label: 'Corn-Soybean', color: '#FFFF00'},
                ...
                UnitedStates_250m_L5_v20170322_2013: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=UnitedStates_250m_L5_v20170322_2013_1&band={band}'
                    },
                    legend: [
                        // {label: 'Not Classified', color: '#000000'},
                        {label: 'Corn-Soybean', color: '#FFFF00'},
                ...
                Global_1000m_L4_v20120101: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/JustinPoehnelt/products&id=Global_1000m_L4_v20120101&band={band}'
                    },
                    legend: [
                ...
                Global_1000m_L3_v20150101: {
                    ...
                    params: {
                        options: {band: 'class'},
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/JustinPoehnelt/products&id=Global_1000m_L3_v20150101&band={band}'
                    },
                    legend: [
                ...
                HumanDevelopment_30m_L1_v20170612: {
                    ...
                    type: 'xyz',
                    params: {
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=Human_Settlement_v5',
                    },
                ...
                WaterOccurrence_30m_L1_v20170620: {
                    ...
                    type: 'xyz',
                    params: {
                        url: '//tiles.croplands.org/{z}/{x}/{y}/tile.png?collection=users/croplandsdev/products&id=WaterOccurrence_20170620',
                    },
